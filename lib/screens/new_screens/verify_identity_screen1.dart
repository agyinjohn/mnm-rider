...
import 'verify_identity_screen2.dart';

class VerifyIdentityScreen1 extends StatelessWidget {
  const VerifyIdentityScreen1({super.key});
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const VerifyIdentityScreen2()));
                },
                child: _card(
                  context,
  ...
  Widget _card(BuildContext context, Icon cardIcon, String title,
      String subTitle, Widget trailingIcon
