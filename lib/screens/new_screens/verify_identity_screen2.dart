...
import 'verify_identity_screen3.dart';

class VerifyIdentityScreen2 extends StatelessWidget {
  const VerifyIdentityScreen2({super.key});
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const VerifyIdentityScreen3()));
                },
                child: _card(
                  context,
                  const Icon(IconlyBroken.camera),
